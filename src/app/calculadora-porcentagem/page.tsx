      ...
      <section className="mt-12 max-w-4xl mx-auto space-y-10 text-gray-700">
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Descontos em compras:</strong> Quando um produto esta com &quot;30% OFF&quot;, multiplique o preco por 0,70 para obter o valor final. Produto de R$ 249,90 com 30% de desconto: R$ 249,90 x 0,70 = R$ 174,93.</li>
