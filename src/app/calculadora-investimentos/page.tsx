    ...
    >
      ...
      <section className="mt-8 border-t border-gray-200 pt-6 max-w-4xl mx-auto">
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4 text-sm text-amber-800">
          Simulacao simplificada. Nao considera IOF para prazos abaixo de 30 dias, taxas de administracao ou eventos de credito.
        </div>
        ...
        <div className="mt-4 text-xs text-gray-500">
          ...
          <ul className="list-disc pl-4 space-y-0.5">
            <li>Decreto 6.306/2007 — tabela regressiva de IOF sobre operacoes financeiras</li>
            <li>Receita Federal do Brasil — tabela regressiva de Imposto de Renda sobre renda fixa</li>
            <li>CVM (Comissao de Valores Mobiliarios) — regulamentacao de investimentos</li>
            <li>Tesouro Nacional — titulos publicos e Tesouro Direto</li>
          </ul>
