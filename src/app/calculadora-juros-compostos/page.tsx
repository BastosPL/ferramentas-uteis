      ...
      <section className="mt-12 max-w-4xl mx-auto space-y-10 text-gray-700">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            ...
            <li><strong>Compare investimentos:</strong> Use a calculadora para comparar diferentes cenarios. Teste taxas de 0,5%, 0,8% e 1% ao mes com o mesmo capital e prazo para visualizar o impacto real de escolher um investimento com rendimento superior. Para comparar CDB, LCI/LCA e Tesouro Direto com desconto de IR, use a <a href="/calculadora-investimentos" className="text-emerald-600 hover:underline">Calculadora de Investimentos</a>.</li>
