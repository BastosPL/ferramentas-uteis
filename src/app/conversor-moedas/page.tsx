      ...
      <section className="mt-12 max-w-4xl mx-auto space-y-10 text-gray-700">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            ...
            <li><strong>Compras internacionais:</strong> Para compras em sites estrangeiros (AliExpress, Amazon EUA), use o conversor para ter nocao do preco real em reais antes de finalizar o pedido, considerando o frete e impostos de importacao. Se precisar converter tamanhos de roupas ou calcados, consulte a <a href="/tabela-medidas" className="text-teal-600 hover:underline">Tabela de Medidas</a>.</li>
          </ul>
        </div>
      </section>
    </ToolPage>
